...
public class Main {
    public static void main(String[] args) {
        ...
        switch (opcion) {
            ...
            case 2:
                //2) Realizar un pequeño programa que permita ingresar 3 númerose imprimir por consola cuál es el mayor.
            ...
            case 8:
                ...
                if(primos(num)==true){
                    ...
                    System.out.println("Eñ numero no es primo");
                }
                break;
            ...
            case 9:
                ...
                do{
                    ...
                    System.out.println("Quiere ingresar otro numero S/N?");
            ...
            case 13:
                ...
                Ingreso de datos, Capacidad disponible, Dinero recaudado, Salir del sistema.
                Crear las variables correspondientes para controlar la capacidad y el dinero recaudado.
                Siendo la capacidad máxima de 500 personas y la entrada costar 1500 por persona y 2000 la entrada vip.
                La primera opción del menú deberá tomar los datos personales del ingresante (nombre, edad, DNI y pase).
                El algoritmo deberá detectar si la persona está apta para el ingreso, ya que solo se dejará pasar a los mayores de 21 años.
                Verificar antes de cobrar la entrada si posee pase vip con el cual ingresará gratis o si posee pase con descuento el cual le permitirá solo abonar la mitad del valor de la entrada.
